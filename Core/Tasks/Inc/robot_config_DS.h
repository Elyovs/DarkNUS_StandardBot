...
#define PITCH_ANGLE_KU			1900
#define PITCH_ANGLE_TU			0.13
#define PITCH_ANGLE_KP	  		425			//0.6*PITCH_ANGLE_KU
#define PITCH_ANGLE_KD  		2.2*PITCH_ANGLE_TU
#define PITCH_ANGLE_KI  		PITCH_ANGLE_TU/6
#define PITCH_ANGLE_INT_MAX		1000

#define PITCHRPM_KU				600
#define PITCHRPM_TU				0.05
#define PITCHRPM_KP				600			//0.6*PITCHRPM_KU
#define PITCHRPM_KI				2.2*PITCHRPM_TU
#define PITCHRPM_KD				PITCHRPM_TU/6
...
#define YAW_ANGLE_KU			1700
#define YAW_ANGLE_TU			0.1
#define YAW_ANGLE_KP			375//0.6*YAW_ANGLE_KU
#define YAW_ANGLE_KI			2.2*YAW_ANGLE_TU
#define YAW_ANGLE_KD			YAW_ANGLE_TU/6
#define YAW_ANGLE_INT_MAX		100

#define YAWRPM_KU				1100
#define YAWRPM_TU				0.125
#define YAWRPM_KP				1000//0.6*YAWRPM_KU
#define YAWRPM_KI				2.2*YAWRPM_TU
#define YAWRPM_KD				YAWRPM_TU/6
